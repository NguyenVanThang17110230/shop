            ...
            result = cart.map((item, index) => {
                return (
                    <CartItem
                        ...
                        sizeName={this.findNameSize(item.product.code, item.idProductSize)}
                        idSizeProduct = {this.findIdSizeProduct(item.product.code, item.idProductSize)}
                    />
                );
            });
        }
